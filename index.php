...
<!-- Full Screen Image for infinity host website -->
<!-- <img src="images/bmcc.JPEG" class="full-screen-image" alt="Full screen background image"> --> 
<body>
  <main>
    ...
    <section class="hero-section d-flex justify-content-center align-items-center" id="section_1">
      <div class="container">
        <div class="row">
          <div class="col-lg-6 col-12 mx-auto">
            <small>
              <a rel="nofollow" target="_blank" href="https://www.pexels.com/video/digital-projection-of-the-earth-mass-in-blue-lights-3129957/"></a></small>
            <!-- please set the date time in the init.js file -->

            <h1 class="text-white mt-2 mb-4 pb-2">INCOMPLETE GRADE</h1>
      ...
      <div class="video-wrap">
        <video autoplay loop muted controls class="custom-video" poster="">
          <source src="videos/bmcc.mp4" type="video/mp4" />
        </video>
      </div>
    </section>
